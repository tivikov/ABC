...
gulp.task('code', function() {
	...
	.pipe(headerfooter.header('app/templates/header.html'))
	.pipe(headerfooter.footer('app/templates/footer.html'))
	.pipe(gulp.dest('app/'))
	.pipe(browserSync.reload({ stream: true }))
});
...
gulp.task('buildImages', function() { return gulp.src(['app/img/**/*']).pipe(gulp.dest('dist/img')) });
...
gulp.task('build', gulp.series('removedist', 'styles', 'scripts','buildImages', 'buildFiles', 'buildCss', 'buildJs', 'buildFonts'));
...
if (gulpVersion == 3) {
	...
	gulp.task('watch', taskArr, function() {
		...
		gulp.watch('app/pages/*.html', ['code']);
...
if (gulpVersion == 4) {
	...
	gulp.task('watch', function() {
		...
		gulp.watch('app/pages/*.html', gulp.parallel('code'));
